...
public class MeepMeepTesting {
    static Vector2d PreloadDrop = new Vector2d(-52, -52);
    static Vector2d samplePick1 = new Vector2d(-60, -45);
    static Vector2d samplePick2 = new Vector2d(-48, -35);
    static Vector2d samplePick3 = new Vector2d(-48, -35);
    ...
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(-39, -64, Math.toRadians(0)))
                // TODO - PRELOAD
                .strafeToLinearHeading(PreloadDrop, Math.toRadians(45))
                .strafeToLinearHeading(samplePick1, Math.toRadians(60))
                .strafeToLinearHeading(PreloadDrop, Math.toRadians(45))
                .strafeToLinearHeading(samplePick2, Math.toRadians(45))
                .strafeToLinearHeading(PreloadDrop, Math.toRadians(45))
                .strafeToLinearHeading(samplePick3, Math.toRadians(45))
                .strafeToLinearHeading(PreloadDrop, Math.toRadians(45))
