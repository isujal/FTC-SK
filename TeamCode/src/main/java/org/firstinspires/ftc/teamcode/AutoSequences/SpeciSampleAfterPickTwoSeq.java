...
public class SpeciSampleAfterPickTwoSeq {
    public SpeciSampleAfterPickTwoSeq(Intake intake, Outtake outtake) {
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        new ParallelAction(
                                ...
                                intake.ExtensionCommands(Intake.ExtensionState.AUTO_PRE_PICK_TWO)
                        ),
                        new SleepAction(1),
