...
public class SpeciSampleAfterPickSeq {
    public SpeciSampleAfterPickSeq(Intake intake, Outtake outtake) {
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        new ParallelAction(
                                ...
                                intake.ExtensionCommands(Intake.ExtensionState.AUTO_PRE_PICK)
                        ),
                        new SleepAction(1),
